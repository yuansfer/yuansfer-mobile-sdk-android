package com.yuansfer.pay.dropin;
...
public abstract class YSDropInPayActivity extends AppCompatActivity implements IBrainTreeCallback {
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if (requestCode == REQUEST_CODE) {
            if (resultCode == RESULT_OK) {
                ...
                YSBrainTreeListenerHandler.handlerPaymentMethodNonceCreated(result.getPaymentMethodNonce()
